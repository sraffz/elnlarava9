                                                                            ...
                                                                            <div class="modal-dialog">
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-footer">
                                                                                        ...
                                                                                        @else
                                                                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-romboid="{{ $element->rombongans_id }}" data-id="{{ $element->usersID }}"
        ...
        <div class="modal fade" id="ubahstatuskelulusan" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ url('tukarstatussekongan') }}" method="GET" id="ajax_tukar_status" name="ajax_tukar_status">
                        {{ csrf_field() }}
                        <div class="modal-body">
                            <div class="container-fluid">
