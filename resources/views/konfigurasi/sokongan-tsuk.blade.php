                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header with-border">
                            <h3 class="card-title">Sokongan Timbalan SUK (Pengurusan) </h3>
                            <div class="card-tools pull-right">
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                    data-target="#tsukpeng">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <table class="table table-bordered table-striped display2">
                                        ...
                                        <tbody>
                                            <?php $i = 1; ?>
                                            @foreach ($tsukpen as $index => $jawatans)
                                                <tr>
                                                    <td class="text-center">{{ $index+1 }}</td>
                                                    <td>{{ $jawatans->namaJawatan }}</td>
                                                    <td class="text-center">
                                                        <a href="{{ url('padamtsukpen', [$jawatans->idJawatan]) }}" class="btn btn-danger btn-xs">
                    ...
                    <div class="card">
                        <div class="card-header with-border">
                            <h3 class="card-title">Sokongan Timbalan SUK (Pembangunan) </h3>
                            <div class="card-tools pull-right">
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                    data-target="#tsukpem">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <table class="table table-bordered table-striped display2">
                                        ...
                                        <tbody>
                                            <?php $i = 1; ?>
                                            @foreach ($tsukpem as $index => $jawatans)
                                                <tr>
                                                    <td class="text-center">{{ $index+1 }}</td>
                                                    <td>{{ $jawatans->namaJawatan }}</td>
                                                    <td class="text-center">
                                                        <a href="{{ url('padamtsukpem', [$jawatans->idJawatan]) }}" class="btn btn-danger btn-xs">
                                                            <i class="fa fa-close"></i>
                                                            <span>Hapus</span>
                                                        </a>
                                                    </td>
    ...
    <div class="modal fade" id="tsukpeng" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                {!! Form::open(['method' => 'POST', 'url' => 'tambahsokongantsukpen']) !!}
    ...
    <div class="modal fade" id="tsukpem" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                {!! Form::open(['method' => 'POST', 'url' => 'tambahsokongantsukpem']) !!}
                <div class="modal-body">
                    {{ csrf_field() }}
                    <div class="form-group">
                        <label>Nama Jawatan</label>
