...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Laporan Mengikut Negara</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Laporan Mengikut Negara</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="get" action="{{ url('laporan-negara') }}">
                                {{-- {{ csrf_field() }} --}}
                                ...
                                <div class="form-group text-center">
                                    ...
                                    {{-- <a class="btn btn-info" href="{{ route('laporanNegara', [$tahun]) }}">Cetak Laporan</a> --}}
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header with-border text-right">
                            <a type="button" href="{{ route('laporanNegara', [$tahun]) }}" class="btn btn-dark">Cetak Laporan</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <div class="row">
